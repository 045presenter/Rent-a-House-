...
export default function CommercialSpacesPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Commercial Spaces - Rent a House</title>
        <meta name="description" content="Find shops, office spaces, and warehouses for rent across Kenya. Perfect for your business needs." />
      </Helmet>
      ...
      <div className="min-h-screen bg-background">
        <div className="bg-primary text-primary-foreground py-12">
          <div className="section-container">
            <h1 className="text-3xl md:text-4xl font-semibold mb-4">Commercial spaces</h1>
            <p className="text-primary-foreground/90">Find the perfect space for your business</p>
          </div>
        </div>
        ...
        <div className="section-container py-8">
          <div className="bg-card rounded-xl border p-6 mb-8">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-lg font-semibold">Filter commercial spaces</h2>
            </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <h3 className="text-xl font-semibold mb-2">No commercial spaces found</h3>
