...
export default function RentalsPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Rental Properties - Rent a House</title>
        <meta name="description" content="Browse verified rental properties including single rooms, bedsitters, apartments, and more across Kenya." />
      </Helmet>
      ...
      <div className="min-h-screen bg-background">
        <div className="bg-primary text-primary-foreground py-12">
          <div className="section-container">
            <h1 className="text-3xl md:text-4xl font-semibold mb-4">Rental properties</h1>
            <p className="text-primary-foreground/90">Find your perfect home from our verified listings</p>
          </div>
        </div>
